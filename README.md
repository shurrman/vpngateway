...
- Runtime-таблица LAN-хостов, реально использовавших forwarding за последние 15 минут, с OS/device fingerprint и индивидуальным переключателем `Local only`; DNS-only клиенты не попадают в список, bounded nmap scan идёт асинхронно.
